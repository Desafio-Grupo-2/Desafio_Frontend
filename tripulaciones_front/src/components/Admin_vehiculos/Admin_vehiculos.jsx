...
//   useEffect(() => {
//     const filtered = mockVehiculos.filter(
//       (vehiculo) =>
...
//             </h3>
//           </div>
//           <div className="card-content">{mockVehiculos.length}</div>
//         </div>
...
//           </div>
//           <div className="card-content">
//             {mockVehiculos.filter((v) => v.motorizacion === "Eléctrico").length}
//           </div>
//         </div>
...
//           </div>
//           <div className="card-content">
//             {mockVehiculos.filter((v) => v.estado === "mantenimiento").length}
//           </div>
//         </div>
//       </div>
