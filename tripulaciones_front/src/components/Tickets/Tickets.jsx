...
const mockTickets = [
    {
        id: "TCK-0001",
        fecha: "2025-09-20T09:32:00Z",
        conductor: "Juan Pérez",
        vehiculo: "BUS-12",
        estacion: "Shell Central",
        litros: 45.2,
        precioLitro: 1.34,
        metodoPago: "Tarjeta",
    },
...
export default function Tickets() {
    ...
    const totalPeriodo = useMemo(() => ticketsFiltrados.reduce((acc, t) => acc + t.total, 0), [ticketsFiltrados]);
                        ...
                        <table>
                            ...
                            <tbody>
                                {ticketsFiltrados.length === 0 && (
                                    <tr>
                                        <td colSpan={8} className="empty">No hay tickets en el rango seleccionado.</td>
                                    </tr>
                                )}
